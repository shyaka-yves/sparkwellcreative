      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 max-w-5xl mx-auto">
        {partners.map((partner, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="group flex flex-col items-center justify-center p-8 rounded-3xl bg-slate-50 border border-slate-100/50 hover:bg-white hover:shadow-xl transition-all duration-500"
          >
            ...
            <p className="mt-6 text-[11px] font-bold uppercase tracking-widest text-primary/40 group-hover:text-secondary transition-colors">
              {partner.name}
            </p>
          </motion.div>
        ))}
